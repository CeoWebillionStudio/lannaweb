...
?>
<!-- Post Content Column -->
<div class="col-lg-12 hmainpage" id="page_dropinbox">
  <!-- Title -->
  <div class="container">
    <div class="row"><!--Header Row-->
      ...
      <div class="col-xl-5 col-lg-5 col-sm-7 col-12">
        <p class="fhead mt-4 text-success">เอกสารที่ลบ (รับเข้า)</p>
      </div>
      <div class="col-xl-6 col-lg-6 mt-3">
        <div class="row">
          <div class="col-12">
            <input type="text" class="form-control" id="search_drop_in" placeholder="กรอกชื่อเอกสารที่ต้องการค้นหา" onKeyUp='searchdropin()'>
          </div>
        </div>                        
      </div>
    </div>
...
<!-- Detail  -->
<div class="container">
  <div class="row" id="load_drop_in_table"> 
    <div class="col-12">
      <center>
...
function sentdocid(ele){
            ...
            $('#showdraftid').load('Modal/modal_drop_inbox_detail.php',{doc_id:$(ele).data('id')});
        }
$('#load_drop_in_table').load('page/in_drop_inbox.php');
</script>